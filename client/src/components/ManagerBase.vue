...
export default {
  ...
  data: () => ({
    ...
    items: [
      ...
      { text: "Employees", icon: "uil-users-alt", to: { name: "users" } },
  ...
  methods: {
    ...
    isUnderSetup() {
      ...
      return ["work-positions", "departments"].includes(route);
    },
  },
